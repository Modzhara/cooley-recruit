(() => {
    ...
    function initSliders() {
        if (document.querySelector(".review-page__slider")) new swiper_core_Swiper(".review-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".review-page__button-prev",
                nextEl: ".review-page__button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
    ...
    const fileInput2 = document.getElementById("cv2");
    const filePreview2 = document.getElementById("formPreview2");
    if (fileInput) {
        function handleFileChange(file) {
            if (file.size > 5242880) {
                alert("Max file upload size is 5MB.");
                fileInput.value = "";
                return;
            }
            filePreview.innerHTML = '<div class="files-apply__preview"><span>Attached file: ' + file.name + "</span></div>";
        }
        fileInput.addEventListener("change", (() => {
            if (fileInput.files[0]) handleFileChange(fileInput.files[0]);
        }));
    }
    if (fileInput2) {
        function handleFileChange(file) {
            ...
            filePreview2.innerHTML = '<div class="columns-cv__preview"><span>Attached file: ' + file.name + "</span></div>";
        }
        fileInput2.addEventListener("change", (() => {
            if (fileInput2.files[0]) handleFileChange(fileInput2.files[0]);
        }));
    }
    window["FLS"] = true;
    menuInit();
